Shader "CustomPBR/PBRCloth"
{
    Properties
    {
        // 类似天鹅绒的材质 : BaseColor设置为黑色或者深色, SheenColor设置为色度信息(Albedo贴图)
        // 更常见的面料(牛仔布,棉布等) : BaseMap 为色度(Albedo贴图), SheenColor设置为0.04或者设置为基色的亮度
        
        [Toggle(_Velvet)] _Velvet ("天鹅绒:使用SheenMap为基色", Float) = 1.0
        ...
        [Toggle(_SUBSURFACE_COLOR)] _SUBSURFACE_COLOR ("_SUBSURFACE_COLOR",  Float) = 1.0
        _SubsurfaceColor ("SubsurfaceColor", Color)       = (1, 1, 1, 1) // 经材料散射和吸收后的漫反射颜色,可选项
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _SUBSURFACE_COLOR
            
            #pragma shader_feature_local_fragment _Velvet
            ...
            TEXTURE2D(_SheenColorMap);   SAMPLER(sampler_SheenColorMap);
            ...
            real4 PBRFragment(Varyings input) : SV_TARGET
            {
                ...
                half3 subsurfaceColor = _SubsurfaceColor;
